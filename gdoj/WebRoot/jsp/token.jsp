...
<html>
  <head>
	...
	<script src="<%=basePath%>js/gdoj.js"></script>
...
<p>Date:<input style="width: 15em;" class="birthday" name="birthday" value="10/01/1989"/>
</p>
		 ...
		 <div>
			<div class="roundbox round_0123" style="width: 420px;margin: 24px auto;">
					<div class="top-link"> 
		        	 ...
		        	 <br/>
		        	 ss<sx:datetimepicker  name="user.birthday" displayFormat="yyyy-MM-dd" type="date"  />
		        	 <s:actionerror />
					<div class="register-box bg-comments">
						<form  method="post" action="Token.action">
						 	<s:token />
							<table class="table-form">       
			                   <tr>
				                  <td class="field-name">message</td>
				                  <td class="input"> <input   style="width: 250px;"  name="message" maxlength="30"/></td>
			                  </tr>
			                    <tr>
			                        <td colspan="2">
			                            <div style="text-align: center;"><input id="sub" type="Submit" value="submit_"/></div>        
			                        </td>
			                    </tr>
			                    <tr>
			                </table>
